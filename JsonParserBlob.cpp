...
const char * JsonParser::p_defaultTest	= "defaultTest";
const char * JsonParser::p_commTime	    = "commTime";
const char * JsonParser::p_test_time	= "test_time";
const char * JsonParser::p_n_channel	= "n_channel";
const char * JsonParser::p_value	= "value";
const char * JsonParser::p_idTest	= "idTest";